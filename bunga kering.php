...
<div class="product-page-container">
    ...
    <div class="glass" style="margin:0 auto;background:rgba(255,255,255,.85);backdrop-filter:blur(10px);padding:30px;border-radius:25px;border:1px solid #e8d9d1;">
        ...
        <p style="margin-bottom:30px;color:#6b625d;">
            Koleksi bunga kering cantik yang tahan lama dan cocok sebagai dekorasi maupun hadiah spesial.
        </p>
        ...
        <div class="product-grid">
            ...
            <div class="card">
                ...
                <img src="bunga kering/kering1.jpg">

                <h3>Bunga Kering Natural</h3>

                <p>Rp 200.000</p>

                <button class="primary"
                onclick="addCart('Bunga Kering Natural',180000)">
                    Tambah Keranjang
                </button>
            ...
            <div class="card">
                ...
                <img src="bunga kering/kering2.jpg">

                <h3>Bunga Kering Premium</h3>

                <p>Rp 300.000</p>

                <button class="primary"
                onclick="addCart('Bunga Kering Premium',250000)">
                    Tambah Keranjang
                </button>
            ...
            <div class="card">
                ...
                <img src="bunga kering/kering3.jpg">

                <h3>Bunga Kering Eksklusif</h3>

                <p>Rp 350.000</p>

                <button class="primary"
                onclick="addCart('Bunga Kering Eksklusif',320000)">
                    Tambah Keranjang
                </button>
